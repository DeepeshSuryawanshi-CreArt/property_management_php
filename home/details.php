      ...
      <div class="row g-4 align-items-start">
        <div class="col-lg-7">
          <div class="property-media shadow-sm rounded-3 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=1400&q=80" alt="Modern Luxury Villa" class="img-fluid main-photo">
          </div>
        </div>
        <div class="col-lg-5">
          <div class="card details-card shadow-sm p-4">
            <h1 class="h4 fw-bold mb-2">Modern Luxury Villa</h1>
            <div class="mb-3">
              <span class="badge bg-primary me-2">Villa</span>
              <span class="badge bg-success">Sale</span>
            </div>
            <p class="text-muted mb-2"><i class="fa fa-map-marker-alt me-2"></i> 124 Palm Avenue, Beverly Hills, CA 90210, USA</p>
            <p class="h4 text-primary fw-bold mb-3">$3,500,000</p>
            ...
            <p class="mb-4 text-muted">Experience luxurious living in this modern villa with panoramic views, open-plan living areas, and designer finishes. Located in a prestigious neighborhood close to amenities.</p>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
        <div class="col">
          <div class="card property-card h-100">
            <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=800&q=80" class="card-img-top" alt="Property 1">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card property-card h-100">
            <img src="https://images.unsplash.com/photo-1460518451285-97b6aa326961?auto=format&fit=crop&w=800&q=80" class="card-img-top" alt="Property 2">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card property-card h-100">
            <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=800&q=80" class="card-img-top" alt="Property 3">
            <div class="card-body">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-4 mb-md-0">
          ...
          <p class="small">Your trusted partner for finding, buying, and renting properties. Experience a seamless journey to your dream home.</p>
        </div>
        <div class="col-md-4 mb-4 mb-md-0">
